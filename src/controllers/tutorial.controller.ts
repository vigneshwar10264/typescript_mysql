...
import tutorialRepositories from "../repositories/tutorial.repositories";
...
export default class TutorialController {
  async create(req: Request, res: Response) {
    ...
    try {
      ...
      const savedTutorial = await tutorialRepositories.save(tutorial);
  ...
  async findAll(req: Request, res: Response) {
    ...
    try {
      const tutorials = await tutorialRepositories.retrieveAll({ title: title });
  ...
  async findOne(req: Request, res: Response) {
    ...
    try {
      const tutorial = await tutorialRepositories.retrieveById(id);
  ...
  async update(req: Request, res: Response) {
    ...
    try {
      const num = await tutorialRepositories.update(tutorial);
  ...
  async delete(req: Request, res: Response) {
    ...
    try {
      const num = await tutorialRepositories.delete(id);
  ...
  async deleteAll(req: Request, res: Response) {
    try {
      const num = await tutorialRepositories.deleteAll();
  ...
  async findAllPublished(req: Request, res: Response) {
    try {
      const tutorials = await tutorialRepositories.retrieveAll({ published: true });
